...
.constant('ApiEndpoint', {
    ...
    .controller('HallCtrl', ['downloadapp', '$interval', '$rootScope', '$stateParams', 'browser', "$scope", "$state", "$http", "showAlertMsg", "ApiEndpoint", "UserInfo", "$ionicLoading", "$ionicHistory", "serializeUrl", "HttpStatus", function(downloadapp, $interval, $rootScope, $stateParams, browser, $scope, $state, $http, showAlertMsg, ApiEndpoint, UserInfo, $ionicLoading, $ionicHistory, serializeUrl, HttpStatus) {
        ...
        var jpglist = [{
                    "imgurl": "img/banner1.jpg?0818",
                    "type": 4,
                    "url": "practice.plshall"
                },
                {
                    "imgurl": "img/banner2.jpg?0818",
                    "type": "1",
                    "url": "practice.Soccerhall"
                },
                {
                    "imgurl": "img/banner3.jpg?0818",
                    "type": 6,
                    "url": "practice.lottery-super"
                },
            ]
            //['img/banner1.jpg?0818','img/banner2.jpg?0818','img/banner3.jpg?0818'];
        var webplist = [{
                    "imgurl": "img/banner1.webp?0818",
                    "type": 4,
                    "url": "practice.plshall"
                },
                {
                    "imgurl": "img/banner2.webp?0818",
                    "type": "1",
                    "url": "practice.Soccerhall"
                },
                {
                    "imgurl": "img/banner3.webp?0818",
                    "type": 6,
                    "url": "practice.lottery-super"
                },
            ]
