            ...
            msgact: function() {
                ...
                $http({
                    ...
                    if (data.status == 1 && data.data[0].act == 'POP') {
                        ...
                        var d = "<div class='Showcbf' id='msgpop'><div class='fixedcon'><img src='img/" + imgurl + "'><div class='items'><p class='tit'>" + item.title + "</p><p class='num" + altfont + "'>" + conten + "</p></div>" +
